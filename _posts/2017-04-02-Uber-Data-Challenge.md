...
\begin{align} \theta_{i,w} &: \text{team strength rating of team i in week w} \ \theta_{j,w} &: \text{team strength rating of team j in week w} \ \alpha &: \text{baseline home advtange for all teams} \ \alpha_{Ti} &: \text{home advantage of team i} \ \ \text{For any team i we can assume that the team strength in week w is given as follows:} \ \theta_{i,w} & \sim N(\gamma\theta_{i, w-1}, \tau_{w}^2) \ \text{where: } \theta_{i,w-1} &: \text{team strength for team i in week w-1} \ \gamma &: \text{autocorrelation at order 1 for team strength in week w} \ \tau_{w} &: \text{week-level uncertainity in the evolution of team strength} \
